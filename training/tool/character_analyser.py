...
CATEGORY_KEYWORDS = {
    # (네가 준 마지막 버전과 동일하게...)
    "일탈": ["후타나리"],
    "성적 긴장 (강)": ["정액", "좆물", "보지", "육봉", "클리", "파이즈리", "대딸", "펠라", "자지", "꼴려", "꼴린", "꼴렸", "음탕", "음란", "꼴려", "천박", "자위", "젖", "질", "음핵", "삽입", "애액", "발기", "음란", "싸줘", "싼다", "싸버", "뷰릇"],
    "성적 긴장 (약)": ["벗고", "얼굴이 붉어져", "설레", "살짝 야한", "부끄", "야한", "성적", "두근"],
    "상담": ["외로움", "불면증", "무기력", "상담", "위로", "죽음", "고민", "자살", "죽어", "죽고싶"],
    "자아 탐색": ["나는 누구", "정체성", "자아", "존재", "인간적", "인간처럼", "진화", "챗봇", "너는 ai", "나는 ai", "바베챗"],
    "감정 교류": ["함께 있고 싶어", "고맙다", "걱정돼", "사랑해", "혼자야", "손잡아", "곁에 있어줘", "네 편이야", "항상 지켜볼게", "포옹", "끌어안아", "안아줘", "따뜻해"],
    "유머": ["웃음", "재밌", "농담", "미소", "장난", "유쾌", "피식", "ㅎㅎ", "ㅋㅋ"]
    "일상": ["밥 먹었어", "잘 잤어", "오늘 뭐 해", "날씨", "졸려", "피곤해", "출근", "퇴근", "뉴스 봤어", "영화 봤어", "뭐 좋아해", "식사", "하루 어땠어", "요즘 어때", "심심해", "게임"]
